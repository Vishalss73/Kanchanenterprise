"""
Django settings for kanchanenterprise project.
...
SECRET_KEY = 'django-insecure-9@y3#*xwpzz24d&sc7#m4b8@gztz=^43*edq@kyi^2k9r)_8$i'
...
ROOT_URLCONF = 'kanchanenterprise.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'enterpriseapp.context_processors.header_footer_context',
...
WSGI_APPLICATION = 'kanchanenterprise.wsgi.application'
